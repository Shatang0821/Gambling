...
{ 
    ...
    private void OnEnable()
    {
        ...
        if (Type == "Player")
        {
            EventCenter.AddListener<float,float>(GameEvents.OnPlayerHpChange, UpdateStats);
        }
        else if (Type == "Enemy")
        {
            EventCenter.AddListener<float,float>(GameEvents.OnEnemyHpChange, UpdateStats);
        }
    }
    ...
    private void OnDisable()
    {
        if (Type == "Player")
        {
            EventCenter.RemoveListener<float,float>(GameEvents.OnPlayerHpChange, UpdateStats);
        }
        else if (Type == "Enemy")
        {
            EventCenter.RemoveListener<float,float>(GameEvents.OnEnemyHpChange, UpdateStats);
        }
